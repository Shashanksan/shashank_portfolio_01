...
<div className="home_container" onClick={()=>setmenubar(false)}>
        ...
        <p className='home_page_lines'>A Full-Stack Web Developer building dynamic and responsive websites and web applications that contribute to the success of the overall product.</p>
